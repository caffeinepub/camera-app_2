...
export default function AnamorphicOverlay({ isActive }: AnamorphicOverlayProps) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-20 flex flex-col justify-between">
      ...
      >
        <span className="text-amber-400/40 text-xs font-mono tracking-widest uppercase">2.39:1</span>
      </div>
