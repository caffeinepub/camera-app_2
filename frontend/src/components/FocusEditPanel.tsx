...
import { X, Download, Eye, EyeOff, Focus } from 'lucide-react';
...
export default function FocusEditPanel({ videoId, videoDataUrl, onClose }: FocusEditPanelProps) {
    ...
    <div className="fixed inset-0 z-50 bg-black flex flex-col">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-amber-300 text-sm font-semibold font-mono tracking-wide">Focus Edit</span>
        </div>
      ...
      <div className="border-t border-white/10 px-4 py-4 flex flex-col gap-4 bg-black/90">
        ...
        <div className="flex items-center justify-between">
          <span className="text-amber-300/70 text-xs font-mono tracking-wide">BOKEH PREVIEW</span>
          <button
        ...
        <div className="flex flex-col gap-2">
          <div className="flex justify-between items-center">
            <span className="text-amber-300/70 text-xs font-mono tracking-wide">FOCUS RADIUS</span>
            <span className="text-amber-400 text-xs font-mono">{Math.round(focusRadius * 100)}%</span>
          </div>
          <Slider
            min={5}
            max={60}
        ...
        <div className="flex flex-col gap-2">
          <div className="flex justify-between items-center">
            <span className="text-amber-300/70 text-xs font-mono tracking-wide">BLUR INTENSITY</span>
            <span className="text-amber-400 text-xs font-mono">{blurIntensity}px</span>
          </div>
          <Slider
            min={2}
            max={40}
