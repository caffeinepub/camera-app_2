 ...
 */
function applyNoiseReduction(imageData: ImageData, passes: number): ImageData {
...
export function useNoiseReduction(
  autoEnableForLowLight = false,
): UseNoiseReductionReturn {
  ...
  }, [autoEnableForLowLight, strength]);
